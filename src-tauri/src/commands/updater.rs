...
const GITHUB_LATEST_RELEASE_API: &str =
    "https://api.github.com/repos/veniai/002-eye-review/releases/latest";

const GITHUB_LATEST_RELEASE_PAGE: &str = "https://github.com/veniai/002-eye-review/releases/latest";

const UPDATE_STATUS_EVENT: &str = "update-status";

const UPDATER_JSON_ENDPOINTS: &[&str] = &[
    "https://github.com/veniai/002-eye-review/releases/latest/download/updater.json",
    "https://gh-proxy.cn/https://github.com/veniai/002-eye-review/releases/latest/download/updater-ghproxy.json",
    "https://gh-proxy.com/https://github.com/veniai/002-eye-review/releases/latest/download/updater-ghp.json",
];
...
mod tests {
    ...
    fn 更新清单候选应优先显式版本地址再回退latest地址() {
        ...
        assert_eq!(
            candidates,
            vec![
                "https://github.com/veniai/002-eye-review/releases/download/v1.0.24/updater.json"
                    .to_string(),
                "https://github.com/veniai/002-eye-review/releases/latest/download/updater.json"
                    .to_string(),
            ]
    ...
    fn 更新清单候选应保留代理前缀并规范化版本号() {
        ...
        assert_eq!(
            candidates,
            vec![
                "https://gh-proxy.cn/https://github.com/veniai/002-eye-review/releases/download/v1.0.24/updater-ghproxy.json"
                    .to_string(),
                "https://gh-proxy.cn/https://github.com/veniai/002-eye-review/releases/latest/download/updater-ghproxy.json"
                    .to_string(),
            ]
    ...
    fn 更新源应优先官方_github() {
        assert_eq!(
            ...
            Some("https://github.com/veniai/002-eye-review/releases/latest/download/updater.json")
        );
    }
}
